...
export const manageClaimsTableConstants = (
    ...
    return [
        ...
        },
        {
            title: "Total Claim",
            render: (rowData: any) => {
                return <span className="text-no-wrap" style={{ marginLeft: "2rem" }}>{rowData.totalClaims}</span>;
            },
        },
        {
            title: "User",
                ...
                return (
                  ...
                  <DuplicateClaim />
                            ...
                            <Image
                                ...
                                src={Restore}
                                onClick={() => restoreClaim(rowData.id)}
                                alt="restore"
                                priority
                            />
                        ) : (
